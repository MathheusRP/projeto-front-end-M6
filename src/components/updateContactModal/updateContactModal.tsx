...
const schema = yup.object({
    ...
    email: yup.string().email('Deve ser um E-mail valido').optional(),
...
export const UpdateContactModal = (props: any) => {
    ...
    const onFormSubmit = (FormData: IContact) => {
        ...
        const update = async (data: IContact, id: number) => {
        ...
        update(FormData, props.contactId)
    }
